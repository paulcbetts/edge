...
v8::Local<v8::Function> ClrFunc::Initialize(System::Func<System::Object^,Task<System::Object^>^>^ func, System::String^ assemblyLocation)
{
    ...
    funcProxy->Set(Nan::New("location").ToLocalChecked(), stringCLR2V8(assemblyLocation));
        ...
        if (jsassemblyFile->IsString()) {
            ...
            result = ClrFunc::Initialize(
                gcnew System::Func<System::Object^,Task<System::Object^>^>(
                    wrap, &ClrFuncReflectionWrap::Call), assembly->Location);
        }
        else {
            ...
            System::Tuple<System::Func<System::Object^,Task<System::Object^>^>^, System::Reflection::Assembly^>^ tuple =
                (System::Tuple<System::Func<System::Object^,Task<System::Object^>^>^, System::Reflection::Assembly^>^)compileFunc->Invoke(
                    compilerInstance, gcnew array<System::Object^> { parameters });


            result = ClrFunc::Initialize(tuple->Item1, tuple->Item2->Location);
        }
...
v8::Local<v8::Value> ClrFunc::MarshalCLRToV8(System::Object^ netdata)
{
    ...
    {
        System::String^ assemblyLocation = ((System::Func<System::Object^,Task<System::Object^>^>^)netdata)->Method->Module->Assembly->Location;

        jsdata = ClrFunc::Initialize((System::Func<System::Object^,Task<System::Object^>^>^)netdata, assemblyLocation);
    }
